...
interface BranchDao {
    ...
    fun getBranchesCurrencies(bankId: String, fromCurrency: String, toCurrency: String): Flowable<List<BranchWithExchangeRate>>
    ...
    fun getCurrencyExchangeRate(branchId: String): Flowable<List<CurrencyExchangeRate>>
